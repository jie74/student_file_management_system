...
<center>
    ...
    include "connect.php";
	session_start();
    $sql = "SELECT * FROM stud_info WHERE sno =".$_SESSION['sno'];
    ...
    ?>
    <form id="myform" name="myform" method="post" action="stud_info1_action.php?action=edit">
        ...
        <table>
            ...
            <tr>
                <td>照片</td>
                <td>
                <input name="pic" type="text" id="pic" value="<?php echo $pic?>" size="30">
